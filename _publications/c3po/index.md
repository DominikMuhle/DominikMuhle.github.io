...
image_mouseover: /assets/mouseover.pdf
...
authors:
  ...
  - name: danielcremers
    affiliations: "1,2"
  - name: christiantheobalt
    affiliations: "2,3"
  - name: adamkortylewski
    affiliations: "1,2"
...
links:
    - name: Paper
      link: https://openreview.net/pdf?id=lqzngsDnPj

citation: '@inproceedings{chic3po,
  title={C3PO: Canonicalization of 3D Pose from Partial Views with Generalizable Correspondence Features},
  author={Chi, Yu and Sommer, Leonhard and D{\"u}nkel, Olaf and Muhle, Dominik and Cremers, Daniel and Theobalt, Christian and Kortylewski, Adam},
